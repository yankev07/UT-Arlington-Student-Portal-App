...
public class RatingsAdapter extends ArrayAdapter<String> {
    ...
    public RatingsAdapter(Context context, String[] names, int[] images){

        super(context, R.layout.fragment_ratings_spinner, names);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent){
        ...
        View row = inflater.inflate(R.layout.fragment_ratings_spinner, null);
